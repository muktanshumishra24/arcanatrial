...
let provider;
const auth = new AuthProvider("9b74fe1913101eec12b06fb9b8fa579ced8b91f9", {
  network: "dev",
  alwaysVisible: true,
  position: "right",
  theme: "dark"
...
async function addToken() {
  try {
    ...
    //     type: "ERC721",
    //     options: {
    //       address: "0xdd03355f86270c4fc3bfa2d99c12540764f3786a",
    //       token_id:
    //         "57934446494755575015343905315045939479642979767544130360694570163757472760388",
    //       name: "bayc"
    //     }
    //   }
    // });
...
async function linkLogin() {
  ...
  await auth.loginWithLink("shrinath@newfang.io");
